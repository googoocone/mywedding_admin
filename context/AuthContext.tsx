...
interface AuthContextType {
  admin: any; // 실제 프로젝트에서는 any 대신 구체적인 유저 타입을 정의하는 것이 좋습니다.
...
export const AuthProvider = ({ children }: any) => {
  const [admin, setAdmin] = useState<any>(undefined); // 초기 user 상태를 undefined로 설정 (로딩 전 상태)
  ...
  return (
    <AuthContext.Provider value={{ admin, setAdmin, fetchUser, isLoading }}>
      {children}
